...
void edit_tape_dialog (GtkWidget *widget)
{
  ...
  //gtk_window_set_transient_for (GTK_WINDOW(dialog), GTK_WINDOW(twindow));
  ...
  //cancel_button = gtk_dialog_add_button (dialog, "Cancel", GTK_RESPONSE_CANCEL);
  ...
  //ok_button = gtk_dialog_add_button (dialog, "OK", GTK_RESPONSE_OK);
  ...
  //gtk_box_pack_start (GTK_BOX(GTK_DIALOG(dialog)->vbox), frame, TRUE, TRUE, 10);
  ...
  g_object_set_data (GTK_OBJECT(dialog), "entry", dlg_entry);
  ...
  g_object_set_data (GTK_OBJECT(dialog), "twindow", twindow);
...
GtkWidget* dialog_new (GtkWidget *widget, DialogItem *dlg, ButtonItem *btns)
{
  ...
  g_object_set_data (GTK_OBJECT(ndialog), "twindow", twindow);*/
...
void dlg_preferences_show (GtkWidget *widget)
{
  ...
  g_object_set_data (window, "precision_spin", spinbutton);
  g_object_set_data (window, "fp_checkbutton", checkbutton);
  ...
  g_object_set_data (window, "show_headers", checkbutton2);

  checkbutton2 = gtk_check_button_new_with_label ("Save Current Window Size");
  gtk_box_pack_start (GTK_BOX(vbox3), checkbutton2, FALSE, TRUE, 10);
  gtk_widget_show (checkbutton2);
  g_object_set_data (window, "save_win_check", checkbutton2);
  ...
  g_object_set_data (window, "entry_font", entry);
  ...
  gtk_widget_show (button);
  g_object_set_data (window, "tape_font", entry);
  ...
  gtk_box_pack_start (GTK_BOX(hbox), button,TRUE, FALSE, 5);
  gtk_widget_show (button);
  g_object_set_data (window, "button_font", entry);
  ...
  gtk_widget_show (entry);
  g_object_set_data (window, "print_command", entry);
  ...
  gtk_widget_show (entry);
  g_object_set_data (window, "page_width", entry);
  ...
  gtk_entry_set_text (GTK_ENTRY(entry), buffer);
  gtk_widget_show (entry);
  g_object_set_data (window, "column_width", entry);
  ...
  g_object_set_data (window, "twindow", cw->window);
...
void dlg_print (GtkWidget *widget)
{
  ...
  /* g_signal_connect (rbutton1, "toggled", */
  ...
  /* g_object_set_data (rbutton1, "entry", entry1); */
  /* g_object_set_data (window, "printer_button", rbutton1); */
  ...
  /* rbutton2 = gtk_radio_button_new_with_label ( */
	 ...
	 /*       "File    "); */
  /* g_signal_connect (rbutton2, "toggled", */
		/*       G_CALLBACK(dlg_set_radio_entry_insensitive), */
		/*       NULL); */
  ...
  /* g_object_set_data (rbutton2, "entry", entry2); */
  /* g_object_set_data (window, "print_file_button", rbutton2); */
  ...
  /* gtk_box_pack_start (GTK_BOX(hbox), rbutton1, FALSE, FALSE, 0); */
  /* g_object_set_data (window, "fname_header_button", rbutton1); */
  ...
  /* gtk_box_pack_start (GTK_BOX(hbox), rbutton2, FALSE, FALSE, 0); */
  /* g_object_set_data (window, "no_header_button", rbutton2); */
  ...
  /* g_signal_connect (rbutton2, "toggled", */
		...
		/*       NULL); */
  /* gtk_box_pack_start (GTK_BOX(hbox), rbutton2, FALSE, FALSE, 0); */
  /* g_object_set_data (window, "custom_header_button", rbutton2); */
  ...
  /* g_object_set_data (window, "column_width_entry", entry1); */
  /* g_object_set_data (window, "page_width_entry", entry2); */
  /* g_object_set_data (window, "cwindow", cw); */
  /* g_object_set_data (window, "twindow", window); */
...
void dlg_set_radio_entry_insensitive (GtkWidget *widget)
{
  ...
  entry = g_object_get_data (widget, "entry");
...
void dlg_font_select (GtkWidget *widget, gpointer data)
{
  ...
  g_object_set_data (GTK_OBJECT(fs), "entry", entry);*/
...
{
  gchar *font;
  GtkWidget *entry = g_object_get_data (widget, "entry");
...
void destroy_dialog(GtkWidget *widget, gpointer data)
{
  ...
  data_to_free = g_object_get_data (widget, "gfree_data");
  if (data_to_free)
